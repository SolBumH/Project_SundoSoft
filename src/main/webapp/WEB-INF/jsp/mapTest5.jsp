	...
	const map = new ol.Map({ 
	  ...
	  view : view
		...
		map.on('singleclick', function (evt) {
		  console.log(sdLayer.getSource());
		  clickURL = 'http://localhost/geoserver/solbum/wms?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetFeatureInfo&FORMAT=image/png&TRANSPARENT=true&QUERY_LAYERS=solbum:tl_bjd&LAYERS=solbum:tl_bjd&exceptions=application/vnd.ogc.se_inimage&INFO_FORMAT=text/html&SRS=EPSG:3857&WIDTH=256&HEIGHT=256';
//	    document.getElementById('info').innerHTML = '';
	    ...
	    let info = sdLayer.getSource().getFeatureInfoUrl(
	        evt.coordinate, 
	        viewResolution, 
	        'EPSG:3857',
